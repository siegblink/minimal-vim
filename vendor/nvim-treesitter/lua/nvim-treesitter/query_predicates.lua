...
-- Neovim 0.12: match[id] now returns a list of nodes instead of a single node.
-- Unwrap to keep downstream node method calls working.
...
query.add_predicate("nth?", function(match, _pattern, _bufnr, pred)
  ...
  local node = unwrap_node(match[pred[2]]) ---@type TSNode
